...
public interface IGraphPluginManager
{
    ...
    ///     Optional metadata to attach to nodes. The dictionary key represents the node identifier, and the value contains a
    ///     dictionary of key-value metadata pairs.
    /// </param>
    /// <param name="edgeMetadata">
    ///     Optional metadata to attach to edges. The dictionary key represents the edge identifier (e.g., "fromNode->toNode"),
    ///     and the value contains a dictionary of key-value metadata pairs.
    /// </param>
    /// <returns>
